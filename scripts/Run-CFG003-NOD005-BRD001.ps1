...
if ($ResumeLatestFailed) {
    ...
    $candidate = Get-ChildItem -LiteralPath $outputRoot -Directory -Filter 'OUT__RNG002__CFG003__NOD005__BRD001__RUN-*' -ErrorAction SilentlyContinue |
    ...
    if ($null -eq $candidate) {
        throw 'No incomplete RNG002/CFG003/NOD005/BRD001 output run was found.'
    }
