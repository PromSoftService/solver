...
if ($ResumeLatestFailed) {
    ...
    $candidate = Get-ChildItem -LiteralPath $outputRoot -Directory -Filter 'OUT__RNG002__CFG003__NOD004__BRD001__RUN-*' -ErrorAction SilentlyContinue |
    ...
    if ($null -eq $candidate) {
        throw 'No incomplete RNG002/CFG003/NOD004/BRD001 output run was found.'
    }
...
try {
    ...
    $studyArgs = @{
        ...
        ExpectedRaiseAmount = [int]$spec.expected_native_actions.btn_response_raise
