...
$allowedDecisionNodes = @('BB_FIRST', 'UTG_CBET', 'BB_RESPONSE', 'UTG_VS_CHECK_RAISE', 'UTG_VS_DONK', 'BB_VS_DONK_RAISE', 'UTG_OOP_CBET', 'BTN_RESPONSE', 'BTN_STAB', 'UTG_RESPONSE', 'BTN_CBET', 'BB_VS_BTN_CBET', 'BTN_VS_CHECK_RAISE', 'BTN_VS_DONK', 'BB_VS_BTN_DONK_RAISE')
