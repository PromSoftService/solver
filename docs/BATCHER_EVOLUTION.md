...
10. **Human simplification research.** Candidate flop partitions and subgroup selectors were tested manually from existing combo data. STU002 has approved three-column examples for BB response to c-bet, UTG responses to check-raise and donk, and BB response to the donk-raise. STU004 has an approved four-column UTG response to BTN stab and a three-column BTN response to UTG c-bet. No production script generates or consumes these tables, and canonical solver workbooks remain unchanged.
