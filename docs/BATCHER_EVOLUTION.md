...
10. **Human simplification research.** Candidate flop partitions and subgroup selectors were tested manually from existing combo data. The approved STU002 BB-defense example is documented as a four-class teaching table with its audit evidence; no production script generates or consumes it, and canonical solver workbooks remain unchanged.
