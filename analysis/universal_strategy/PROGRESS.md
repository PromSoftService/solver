...
## EXP-004 completion
Raw profiles generated by tools/raw_cell_structure.py. GHA 34163552623; input code 3c88ccb90818882716a5734644fcce6afb3ce1b5. Seven studies, 13 classes, 15 rows, 1365 cells. No human actions, merges, policy search, equity or reruns of EXP-001/002/003. Protected-file diff and table validation passed.
Outputs: experiments/EXP-004.json (full profiles and descriptive neighboring-column distances), EXP-004.md (frequencies/reach/forced losses), EXP-004-matrices.md (compact seven matrices), EXP-004-cells.csv, EXP-004/ (per-study JSON). Zero-reach and absent cells distinguished.
